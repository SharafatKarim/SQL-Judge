...
<head>
  ...
  <title>SQL Judge | Privacy Policy</title>
    ...
    <div class="leftcolumn">
      <div class="card">
        ...
        <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
          ...
          with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank">Privacy
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
              or &quot;Our&quot; in this Agreement) refers to SQL Judge.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to SQL Judge, accessible from <a href="localhost"
                rel="external nofollow noopener" target="_blank">localhost</a></p>
          </li>
          <li>
      ...
      <div class="card">
        ...
        <ul>
          <li>
            <p>By email: sharafat@duck.com</p>
          </li>
          <li>
            <p>By visiting this page on our website: <a href="https://sharafat.pages.dev/"
                rel="external nofollow noopener" target="_blank">https://sharafat.pages.dev/</a></p>
          </li>
        </ul>
      </div>
    </div>
