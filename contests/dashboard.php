...
<div class="row">
    <div class="leftcolumn">
        <div class="card">
            ...
            <h5>By <?php echo htmlspecialchars($contest['username']); ?> | Starts: <?php echo htmlspecialchars($contest['start_time']); ?> | Ends: <?php echo htmlspecialchars($contest['end_time']); ?></h5>
            <p><?php echo nl2br(htmlspecialchars($contest['description'])); ?></p>
            <div class="row2">
                <?php if ($is_creator): ?>
                    <a href="./delete_contest.php?id=<?php echo $contest_id; ?>" class="green-button" onclick="return confirm('Are you sure you want to delete this contest?');">Delete Contest</a>
                    <a href="./add_problem.php?contest_id=<?php echo $contest_id; ?>" class="green-button">Add Problemsets</a>
                <?php endif; ?>
